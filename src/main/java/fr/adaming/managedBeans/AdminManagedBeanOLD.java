...
//
// FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("lCatSession",
// listCat);
// FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("lPdtSession",
// listPdt);
// FacesContext.getCurrentInstance().getExternalContext().getSession(false);
//
// return "homeAdmin";
...
// return "catDisplay";
// } else {
// FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Category
// not created"));
//
// return "addCat";
// }
...
// return "catDisplay";
// } else {
// FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Update
// failed"));
// return "updateCat";
// }
//
...
// return "pdtDisplay";
// } else {
// FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Product
// not created"));
// return "addPdt";
// }
// }
